...
HTML_INPUT = "music_list_source.html"   # Cambia si lo deseas
CSV_OUTPUT = "music_list.csv"
...
def main():
    ...
    print(f"✅ CSV generated: {CSV_OUTPUT} (records: {len(all_tracks)})")
    print("ℹ️ Fill the 'FileName' column with the exact filename of the real file in Music_List/.")
